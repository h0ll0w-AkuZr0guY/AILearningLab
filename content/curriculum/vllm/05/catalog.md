...
id: "vllm-05"
order: 5
title: "05 · OpenAI API、Streaming 与工具调用"
goal: "对齐协议、SSE、取消、usage 与错误语义。"
lab: "实现一个兼容 chat completions 的最小代理。"
interview: "OpenAI-compatible 不等于行为完全一致，差异在哪里？"
officialScope: "https://docs.vllm.ai/"
sourceScope: "vllm/entrypoints/openai"
planningStatus: draft
---

# 05 · OpenAI API、Streaming 与工具调用
