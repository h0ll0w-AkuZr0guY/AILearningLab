...
order: 9
title: "09 · 声明文件与库设计"
goal: "从消费者视角设计稳定的 .d.ts，而非给实现补类型。"
lab: "为一个 JS 库补全 declaration 与 dtslint 样例。"
interview: "interface 和 type 在公共 API 中怎么选？"
officialScope: "https://www.typescriptlang.org/docs/"
sourceScope: "src/compiler/declarationEmitter.ts"
